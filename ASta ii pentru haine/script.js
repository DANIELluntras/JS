...
document.querySelector('.btn-buy').addEventListener('click', redirectToCheckout);
...
function placeOrder(event) {
    ...
    // Aici puteți adăuga codul pentru a trimite datele comenzii către un server sau pentru a le procesa în alt mod.

    // După ce comanda este plasată cu succes, puteți șterge datele din localStorage
